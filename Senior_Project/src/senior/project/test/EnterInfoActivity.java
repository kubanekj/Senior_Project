...
public class EnterInfoActivity extends Activity{
	public void onCreate(Bundle savedInstanceState) {
      ...
      //If nutrition page button is clicked, start nutrition activity
        ...
        startNutrition.getBackground().setColorFilter(0xFF00A0FF, PorterDuff.Mode.MULTIPLY);
      //If exercise page button is clicked, start exercise activity
        ...
        startExercise.getBackground().setColorFilter(0xFF00A0FF, PorterDuff.Mode.MULTIPLY);
        ...
        startTrack.getBackground().setColorFilter(0xFF00A0FF, PorterDuff.Mode.MULTIPLY);
      //If goal page button is clicked, start goal activity
        ...
        startGoal.getBackground().setColorFilter(0xFF00A0FF, PorterDuff.Mode.MULTIPLY);
      //If weight page button is clicked, start weight activity
        ...
        startWeight.getBackground().setColorFilter(0xFF00A0FF, PorterDuff.Mode.MULTIPLY);
        ...
        goHome.getBackground().setColorFilter(0xFF00A0FF, PorterDuff.Mode.MULTIPLY);
	}
}
